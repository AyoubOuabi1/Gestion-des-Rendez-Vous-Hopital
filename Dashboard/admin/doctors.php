...
<section class="mx-10">
    <div class="flex justify-between mt-6">
        ...
        <button class="bg-blue-500 hover:bg-blue-700 text-white py-1 px-4 rounded mb-6 ml-2"><i class="fa fa-plus mr-2" data-modal-toggle="add-modal"></i>Add New</button>
    </div>
    <div class="mb-6">
            ...
            foreach ($row as $rows) {
                ...
                echo '<tr>
                    ...
                    <td class="px-4 py-2 text-center">
                        <button class="bg-sky-100 hover:bg-blue-700 hover:text-white text-sky-500 py-2 px-4 rounded" onclick="salam()"><i class="fa fa-pencil-alt mr-2"></i>Edit</button>
