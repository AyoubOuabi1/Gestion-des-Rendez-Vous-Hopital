...
<section class="mx-10">
    <div class="flex justify-between mt-6">
        ...
        <button class="bg-blue-500 hover:bg-blue-700 text-white py-1 px-4 rounded mb-6 ml-2" data-modal-toggle="add-modal" name="add" id="add"><i class="fa fa-plus mr-2 add"></i>Add New</button>
    </div>
    <div class="mb-6">
    ...
    <table class="table-fixed border rounded w-full">
        ...
        <tbody>
            ...
            foreach ($row as $rows) {
                $iddoctor = $rows['id'];
                echo '<tr>
                    <td class="px-4 py-2 text-center hidden" id="doctorId' . $iddoctor . '">' . $iddoctor . '</td>
                    <td class="px-4 py-2 text-center hidden" >' . $rows['nationalCode'] . '</td>
                    <td class="px-4 py-2 text-center hidden" >' . $rows['teleNumber'] . '</td>
                    <td class="px-4 py-2 text-center hidden" >' . $rows['firstName'] . '</td>
                    <td class="px-4 py-2 text-center hidden" >' . $rows['lastName'] . '</td>
                    ...
                    <td class="px-4 py-2 text-center">
                        <button class="bg-sky-100 hover:bg-blue-700 hover:text-white text-sky-500 py-2 px-4 rounded" onclick="editDoctor('. $iddoctor. ')"><i class="fa fa-pencil-alt mr-2"></i>Edit</button>
                        <button class="bg-sky-100 hover:bg-blue-700 hover:text-white text-sky-500 py-2 px-4 rounded" data-modal-toggle="authentication-modal" onclick="viewDoctor(' . $iddoctor . ')" ><i class="fa fa-eye mr-2"></i>View</button>
                        <button class=" bg-sky-100 hover:bg-blue-700 hover:text-white text-sky-500 py-2 px-4 rounded"><i class="fa fa-trash mr-2" ><a href="?id=' . $iddoctor . '"></i>Remove</a></button>
                    </td>
                </tr>';
            } ?>
        </tbody>
